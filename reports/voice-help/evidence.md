...
Run 2026-09-13T21:29:30.299Z in 21.7s.
...
- reflow: row [439,558,630,819] → [439,558,630,819]; dialog scroll height 809 → 809
...
- dialog closed by a card interaction: 0 times
- page errors: none

## Every card, by width
- 1440: help-canvas landed anchored-below at [483,221,823,323], glyph [483,177,527,221], dialog [400,16,1040,827], inside the viewport: true
- 1440: help-daemon landed anchored-below at [691,212,1031,332], glyph [691,168,735,212], dialog [400,16,1040,827], inside the viewport: true
- 1440: help-home landed anchored-below at [878,237,1218,357], glyph [878,193,922,237], dialog [400,16,1040,827], inside the viewport: true
- 1440: help-actor landed anchored-below at [474,392,814,513], glyph [474,348,518,392], dialog [400,16,1040,827], inside the viewport: true
- 1440: help-audio landed anchored-below at [676,388,1016,527], glyph [676,344,720,388], dialog [400,16,1040,827], inside the viewport: true
- 1440: help-version landed anchored-below at [896,392,1236,494], glyph [896,348,940,392], dialog [400,16,1040,827], inside the viewport: true
- 1440: help-localfiles landed anchored-below at [512,483,852,603], glyph [512,439,556,483], dialog [400,16,1040,827], inside the viewport: true
- 1440: help-microphone landed anchored-below at [723,489,1063,610], glyph [723,445,767,489], dialog [400,16,1040,827], inside the viewport: true
- 1440: help-key landed anchored-below at [971,627,1311,766], glyph [971,583,1015,627], dialog [400,16,1040,827], inside the viewport: true
...
- 420 light: help-microphone landed flush-below at [16,489,356,609], glyph [135,445,179,489], dialog [17,16,403,844], inside the viewport: true
- 420 light: help-key landed anchored-below at [38,606,378,745], glyph [334,562,378,606], dialog [17,16,403,844], inside the viewport: true
...
- 420 dark: help-microphone landed flush-below at [16,489,356,609], inside the viewport: true
- 420 dark: help-key landed anchored-below at [38,606,378,745], inside the viewport: true

## Steps
- page: a throwaway vite on 5584, pointed at a stub harness on 42681 (5173 and 7654 untouched)
...
- dialog: opened from the cog; 9 help glyphs in it
- closed cards: all 9 hidden by the platform
- 1440 light: 9 cards, positions ["canvas=anchored-below","daemon=anchored-below","home=anchored-below","actor=anchored-below","audio=anchored-below","version=anchored-below","localfiles=anchored-below","microphone=anchored-below","key=anchored-below"], never opened none, off-screen none, past the dialog's inline box ["help-home 878..1218 in 400..1040","help-version 896..1236 in 400..1040","help-microphone 723..1063 in 400..1040","help-key 971..1311 in 400..1040"], document wider than the window: no
- reflow: the row is [439,558,630,819] before and [439,558,630,819] after the card opens (unmoved); the dialog scrolls 809px of content either way (unchanged)
...
- 420x320: 9 cards, positions ["canvas=flush-below","daemon=flush-below","home=flush-below","actor=flush-below","audio=sheet","version=flush-below","localfiles=flush-below","microphone=flush-below","key=sheet"], never opened none, off-screen none, past the dialog's inline box none, document wider than the window: no
- short window: the cards that became sheets ["help-audio","help-key"], off-screen []
