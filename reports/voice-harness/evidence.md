...
Run 2026-09-11T22:59:45.198Z in 3.547s.

- browser: HeadlessChrome 152.0.0.0
- connected to: canvas “Voice evidence” (prj_voice), daemon http://127.0.0.1:35957, home no home configured — the daemon's default
- agent: Voice (usr_AhQ5TwvWGl), NOT enrolled
...
## Steps
- harness: `isocan voice` listening at http://127.0.0.1:7737/ (daemon on 35957, home isocan-voice-evidence-x977Jg)
- connected to: canvas “Voice evidence” prj_voice · daemon http://127.0.0.1:35957 · home no home configured — the daemon's default · agent Voice usr_AhQ5TwvWGl (not enrolled) · audio no provider models/gemini-3.1-flash-live-preview, no key
...
- canvas: last op item.update by Voice (usr_AhQ5TwvWGl), the enrolled agent
