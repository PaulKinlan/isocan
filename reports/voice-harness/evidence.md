...
Run 2026-09-11T22:53:56.310Z in 3.52s.

- browser: HeadlessChrome 152.0.0.0
- connected to: canvas “Voice evidence” (prj_voice), daemon http://127.0.0.1:39195, home no home configured — the daemon's default
- agent: Voice (usr_MySv9DXuBD), NOT enrolled
...
- bars lit immediately after the shutter closed: 12/28 (the level meter has a slow release on purpose; the held-peak marker is what survives a quiet moment)
- layout at 1440: viewport 1440px, document width 1440px, key panel right edge 1414px, panels clipped off-window: 0
- layout at 420: columns 392px, document 420px, panels clipped: 0
...
## Steps
- harness: `isocan voice` listening at http://127.0.0.1:7856/ (daemon on 39195, home isocan-voice-evidence-fAwemu)
- connected to: canvas “Voice evidence” prj_voice · daemon http://127.0.0.1:39195 · home no home configured — the daemon's default · agent Voice usr_MySv9DXuBD (not enrolled) · audio no provider models/gemini-3.1-flash-live-preview, no key
...
- narrow 420px: columns 392px, document 420px, aside 392px (right edge 406px), panels clipped: 0 — /home/paulkinlan/worktrees/isocan-voice-harness/reports/voice-harness/04-narrow-420.png
- canvas: titles now ["Checkout v2","Settings screen"]
- canvas: last op item.update by Voice (usr_MySv9DXuBD), the enrolled agent
