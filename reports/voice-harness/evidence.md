...
Run 2026-09-11T22:56:05.222Z in 3.8s.

- browser: HeadlessChrome 152.0.0.0
- connected to: canvas “Voice evidence” (prj_voice), daemon http://127.0.0.1:42353, home no home configured — the daemon's default
- agent: Voice (usr_4SMXnHZFN7), NOT enrolled
...
## Steps
- harness: `isocan voice` listening at http://127.0.0.1:7666/ (daemon on 42353, home isocan-voice-evidence-9BEXSE)
- connected to: canvas “Voice evidence” prj_voice · daemon http://127.0.0.1:42353 · home no home configured — the daemon's default · agent Voice usr_4SMXnHZFN7 (not enrolled) · audio no provider models/gemini-3.1-flash-live-preview, no key
...
- canvas: last op item.update by Voice (usr_4SMXnHZFN7), the enrolled agent
