...
Run 2026-09-11T23:48:02.586Z in 3.641s.

- browser: HeadlessChrome 152.0.0.0
- connected to: canvas “Voice evidence” (prj_voice), daemon http://127.0.0.1:42555, home no home configured — the daemon's default
- agent: Voice (usr_pC5OBSpKM9), NOT enrolled
...
## Steps
- harness: `isocan voice` listening at http://127.0.0.1:7958/ (daemon on 42555, home isocan-voice-evidence-H3fEYm)
- connected to: canvas “Voice evidence” prj_voice · daemon http://127.0.0.1:42555 · home no home configured — the daemon's default · agent Voice usr_pC5OBSpKM9 (not enrolled) · audio no provider models/gemini-3.1-flash-live-preview, no key
...
- canvas: last op item.update by Voice (usr_pC5OBSpKM9), the enrolled agent
