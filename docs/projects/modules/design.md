...
| **Iodide Status** | External primary audit | **Dormant and discontinued**. Created by Mozilla in 2018 as an experimental in-browser scientific notebook; repository README explicitly declares "no longer under development" as of September 2020 (GitHub API reports `archived: false`, repo created 2017-08-10 at `github.com/iodide-project/iodide`). |
