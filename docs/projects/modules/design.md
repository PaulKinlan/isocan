...
| **Iodide Status** | External primary audit | **Dormant and discontinued**. Created by Mozilla as an experimental in-browser scientific notebook (repository created 2017-08-10; publicly unveiled March 2019; repository README explicitly declares "no longer under development" as of September 2020; GitHub API reports `archived: false` at `github.com/iodide-project/iodide`). |
